...
const HELP_TEXT = `<b>Uçuş Fiyat Takip Botu</b>

/ekle KALKIŞ VARIŞ GİDİŞ_TARİHİ [DÖNÜŞ_TARİHİ]
Örnek (gidiş-dönüş): /ekle IST BEG 2026-10-10 2026-10-16
Örnek (tek yön): /ekle IST BEG 2026-10-10

/listele — takip edilen rotaları gösterir
/sil ID — bir rotayı takipten çıkarır (ID'yi /listele ile görebilirsin)
...
exports.handler = async (event) => {
  try {
    ...
    if (command === "/start" || command === "/yardim" || command === "/help") {
